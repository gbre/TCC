...
A Figura \ref{fig:metodologia-dw} mostra os passos necessários para o projeto de um \textit{Data Warehouse}


\todo[inline, color=SeaGreen!80]{Adicionar os trabalhos de Marcos Sampaio} 
