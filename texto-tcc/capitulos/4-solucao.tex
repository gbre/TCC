...
Integração com Banco de Dados                           & MySQL, SQLServer, Postgree, Oracle entre outros &            &            &            &            \\ \hline
...
Quantidade de Casos Abertos no \textit{Issue Tracker} & 6000                                            &            &            & \checkmark &            \\ \hline

\end{tabular}
\caption{Características do Kettle e avaliação quanto aos critérgios gerais de seleção de ferramentas}
\label{kettle}
\end{table}
\FloatBarrier	
