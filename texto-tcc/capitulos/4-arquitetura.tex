...
\textcolor{red}{\todo[inline, color=yellow!20]{Baufaker, como eu alterei o valor do percentil para a medida, verifique e atualize  a escrita do parágrafo anterior, uma vez que você referenciou exatamente os campos que estavam em negrito.}}
