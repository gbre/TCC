...
Aplicando o segundo passo da metodologia de \citeonline{Kimball2002}, identificou-se a periodicidade como as releases do software, isto é, cada software pode ter tempos diferenciados de lançamento de uma nova versão. Em alguns casos, estas podem ser semestrais ou mensais, contudo em outros casos, é possível obter releases diárias, como resultado da integração de um determinada massa de código em um sistema de integração continua \cite{beckarticle1999}. 
...
Tendo os fatos identificados, foram criados os diagramas de árvore, tal como se vê nas Figuras \ref{fig:percentil-arvore}, \ref{fig:cenario-arvore} e \ref{fig:taxa-arvore},  propostos por \citeonline{Golfarelli1998}.
...
\begin{figure}[ht!]
\centering
\includegraphics[keepaspectratio=true,scale=0.46]{figuras/modelo-dw1.eps}
