...
Para selecionar o software que seria parte da avaliação do ambiente de \textit{Data Warehousing} que é o objeto do estudo de caso, foi considerado os critérios estabelecidos na Tabela \ref{tab:critérios-estudo-de-caso}. 
