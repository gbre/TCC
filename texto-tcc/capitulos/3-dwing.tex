...
Após os fatos e dimensões serem identificados, necessita-se construir o projeto conceitual do \textit{data warehouse}. Embora aplique na construção de modelos relacionais, a construção de um digrama de entidade relacionamento não pode ser aplicado em modelos dimensionais, pois não ficam expressam as navegabilidades entre as hierarquias \cite{Golfarelli1998}.
