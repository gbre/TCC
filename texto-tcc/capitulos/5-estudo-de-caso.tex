...
Apesar do fato de os processos de cadastro, normatização de sítios urbanos tombados e fiscalização de bens imóveis de metodologia\todo[inline, color=SeaGreen!50]{bens imóveis de metodologia, não entendi} já fazerem parte da realidade das Superintendências e Escritórios Técnicos, o processo manual de suporte e gestão dos dados torna a execução precária e morosa.
