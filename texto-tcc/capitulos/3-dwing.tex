...
Uma das técnicas de visualização, que visam transmitir os dados efetivamente e que tem se destacado é o uso dos \textit{dashboards}, que são representações visuais das informaçoes mais importantes e necessárias, que podem ser monitoradas simultaneamente, para atingir um ou mais objetivos de negócio \cite{raquel2013}. \citeonline{raquel2013} também enuncia que cada componente do \textit{dashboard} deve ser pequeno, conciso, claro e intuitivo de modo que o todo deve caber inteiramente em uma tela de computador, tal como se mostra na Figura \ref{dashboard}.

\begin{figure}[ht!]
\centering
	\includegraphics[bb=0 0 753 350, scale=0.8]{figuras/dashboard1.png}
