...
que somadas podem\todo[inline, color=SeaGreen!50]{tem esse tracinho antes do %} consumir até 85\% de todo o esforço em um ambiente de \textit{Data Warehousing}
\cite{Kimball2002}.
...
\textit{staging} que \citeonline{Kimball2002} considera\todo[inline, color=SeaGreen!50]{alguém faltando} com uma área de armazenamento intermediária entre fontes e o \textit{data warehouse}. Normalmente, o ambiente de \textit{staging} é de natureza temporária e o seu conteúdo é apagado após a carga dos dados no \textit{data Warehouse}. 
...
A análise prospectiva consiste em realizar a análise a partir de um conjunto inicial de dados para chegar a dados mais detalhados ou menos detalhados \cite{Inmon1992}. Já a análise seletiva tem como objetivo \todo[inline, color=SeaGreen!50]{Não entendi, trazer à evidência os dados?}trazer à evidência para os dados \cite{andre2000}. Entre as operações de análise prospectiva estão:
