...
Para a implementação das consultas OLAP e Visualização de dados, foram utilizadas duas ferramentas do ambiente Pentaho BI Suite Community Edition. A primeira é o Pentaho BI Platform\footnote{Disponível em \url{http://community.pentaho.com/projects/bi_platform/}}, que tem as principais características  e a análise quanto aos critérios gerais de seleção de ferramentas são apresentadas na Tabela \ref{biserver}.
