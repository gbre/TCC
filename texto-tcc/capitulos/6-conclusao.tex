...
\textcolor{red}{\todo[inline, color=yellow!20]{Aqui seria importante ter o tempo que o IPHAN levava para realizar essa atividade, além da amostragem (qtde) de classes que eram analisadas...}}

Foi possível observar, ao se construir as configurações~"OpenJDK Metrics"~e~"Tomcat Metrics" que a interpretação das métricas de código-fonte pode ser flexibilixada com adoção de padrões convenientes ao software avaliando, cumprindo assim com o objetivo específico \textbf{OE3}. \textcolor{red}{Também não entendi esse parágrafo. Favor reescrever}
